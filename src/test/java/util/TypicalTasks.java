...
public class TypicalTasks {
    ...
    public Deadline deadline_resolveCustomerTicket = new Deadline("Resolve customer ticket", true, LocalDateTime.of(2022, 8, 4, 9, 15));
    public Deadline deadline_finalizeGuestList = new Deadline("Finalize guest list", false, LocalDateTime.of(2021, 6, 24, 14, 33));

    public Event event_projectLaunch = new Event("Project launch", true, LocalDateTime.of(2024, 11, 9, 14, 30), LocalDateTime.of(2026, 12, 25, 9, 0));
    public Event event_birthday = new Event("Birthday", false, LocalDateTime.of(2024, 11, 9, 18, 45), LocalDateTime.of(2024, 11, 9, 22, 45));
    public Event event_anniversary = new Event("Anniversary", true, LocalDateTime.of(2025, 1, 1, 0, 0), LocalDateTime.of(2025, 1, 1, 23, 59));
