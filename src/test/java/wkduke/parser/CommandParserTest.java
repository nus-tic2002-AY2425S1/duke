...
public class CommandParserTest {
    ...
    private static Stream<Object[]> validDeadlineCommandProvider() {
        return Stream.of(
                new Object[]{"deadline Submit report /by 2024-11-05 23:59", new AddDeadlineCommand("Submit report", LocalDateTime.of(2024, 11, 5, 23, 59))},
                new Object[]{"deadline Finish assignment /by 2024/11/06 1800", new AddDeadlineCommand("Finish assignment", LocalDateTime.of(2024, 11, 6, 18, 0))}
        );
    }
    ...
    private static Stream<Object[]> validEventCommandProvider() {
        return Stream.of(
                new Object[]{"event Meeting /from 2024-11-05 09:00 /to 2024-11-05 17:00", new AddEventCommand("Meeting", LocalDateTime.of(2024, 11, 5, 9, 0), LocalDateTime.of(2024, 11, 5, 17, 0))},
                new Object[]{"event Workshop /from 2024/11/06 10:00 /to 2024/11/06 12:00", new AddEventCommand("Workshop", LocalDateTime.of(2024, 11, 6, 10, 0), LocalDateTime.of(2024, 11, 6, 12, 0))}
        );
    }
    ...
    private static Stream<Object[]> validListCommandProvider() {
        return Stream.of(
                ...
                new Object[]{"list /on 2024-11-05", new ListOnCommand(LocalDateTime.of(2024, 11, 5, 0, 0))},
                new Object[]{"list /on 2024/11/05", new ListOnCommand(LocalDateTime.of(2024, 11, 5, 0, 0))}
        );
    }
