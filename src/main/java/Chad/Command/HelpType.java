...
public enum HelpType {
    ...
    "general tasks, eg: do homework"+System.lineSeparator()+
    ...
    "find <find_index> ,find task by keyword in description."+System.lineSeparator()+
    "summary <time_period> , eg. summary 1 week"+System.lineSeparator()+
    ...
    "or say 'bye' to exit "+System.lineSeparator()
    ),
    ...
    EVENT("How to use event: event <task_description> /from <start_time> /to <end_time> " + System.lineSeparator() + 
    " Adds an event task."),
    FIND("How to use find :find <find_index>; " + System.lineSeparator() + 
    "Find a task by searching for a keyword in the task description."),
    SUMMARY("How to use summary :summary <time_period>; " + System.lineSeparator() + 
    "statistics about the items managed by the App e.g., " +
            "show the number of tasks that have been completed in the past 1 week." + System.lineSeparator() + 
            "period format:1 week, 3 days, 2 weeks"),
